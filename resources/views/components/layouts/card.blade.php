...
<div onclick="{{ isset($url) ? "window.location.href='$url'" : '' }}"
    {{ $attributes->merge(['class' => "p-6 mb-6 border-2 border-gray-400 rounded-md shadow-md $currTheme"]) }}>
    @isset($title)
