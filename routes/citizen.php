...
Route::middleware(['auth', 'role:' . UserRole::CITIZEN->value])->prefix('citizen')->name('citizen.')->group(function () {
    ...
    Route::prefix('potholes')->name('pothole.')->group(function () {
        ...
        Route::post('/', [PotholeController::class, 'store'])->middleware([HandlePrecognitiveRequests::class])->name('store');
        ...
        Route::patch('/{pothole}', [PotholeController::class, 'update'])->middleware([HandlePrecognitiveRequests::class])->name('update');
