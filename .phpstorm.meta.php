...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'constants.SUPER_ADMIN' => 'string',
            'constants.ADMIN' => 'string',
            'constants.CITIZEN' => 'string',
            ...
            'filesystems.links.C:\Users\HP\Herd\pothole-mgmt-system\public\storage' => 'string',
            ...
            'services.google_maps.key' => 'string',
...
'cache.prefix','constants.SUPER_ADMIN','constants.ADMIN','constants.CITIZEN','database.default',
...
'filesystems.links.C:\\Users\\HP\\Herd\\pothole-mgmt-system\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.slack.notifications.channel','services.google_maps.key','session.driver','session.lifetime','session.expire_on_close',
...
'web','api',);
        registerArgumentsSet('routes', 'profile','home','about','contact',
'login','register','logout','admin.dashboard','admin.index','citizen.dashboard','citizen.pothole.index',
'citizen.pothole.','citizen.pothole.create','storage.local',);
        registerArgumentsSet('views', 
'about','admin.dashboard','admin.index','auth.login','auth.register',
'citizen.dashboard','components.button','components.form-field','components.icons.location','components.layouts.app-layout',
'components.layouts.navigation','components.logo','components.message-handler','components.nav-link','contact',
'home','pothole.create','pothole.index','profile','laravel-exceptions-renderer::components.card',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VITE_GOOGLE_MAP_API_KEY',);
